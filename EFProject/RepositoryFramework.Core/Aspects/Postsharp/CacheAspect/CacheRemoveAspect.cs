...
using RepositoryFramework.Core.CrossCuttingConcerns.Caching;

namespace RepositoryFramework.Core.Aspects.Postsharp.CacheAspect
{
    [Serializable]
    public class CacheRemoveAspect : OnMethodBoundaryAspect
    {
        ...
        public CacheRemoveAspect(Type cacType)
        {
            _cacheType = cacType;
        }
